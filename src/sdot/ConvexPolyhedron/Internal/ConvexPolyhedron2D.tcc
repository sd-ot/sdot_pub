...
//template<class Pc>
//ConvexPolyhedron2D<Pc>::ConvexPolyhedron2D( const Box &box, CI cut_id ) : ConvexPolyhedron2D() {
//    resize( 4 );
...
//template<class Pc>
//ConvexPolyhedron2D<Pc>::ConvexPolyhedron2D( ConvexPolyhedron2D &&that ) {
//    nodes         = that.nodes        ;
//    size          = that.size         ;
//    rese          = that.rese         ;
...
//template<class Pc>
//ConvexPolyhedron2D<Pc>::ConvexPolyhedron2D() {
//    size          = 0;
//    rese          = block_size;
...
//template<class Pc>
//ConvexPolyhedron2D<Pc> &ConvexPolyhedron2D<Pc>::operator=( const ConvexPolyhedron2D &that ) {
...
//template<class Pc>
//void ConvexPolyhedron2D<Pc>::write_to_stream( std::ostream &os ) const {
//    os << "pos: ";
...
//template<class Pc>
//void ConvexPolyhedron2D<Pc>::display_vtk( VtkOutput &vo, const std::vector<TF> &cell_values, Pt offset ) const {
...
//void ConvexPolyhedron2D<Pc>::for_each_edge( const F &/*f*/ ) const {
//    TODO;
//}

//template<class Pc> template<class F>
//void ConvexPolyhedron2D<Pc>::for_each_node( const F &f ) const {
...
//template<class Pc>
//typename ConvexPolyhedron2D<Pc>::TI ConvexPolyhedron2D<Pc>::nb_nodes() const {
//    return size;
//}

//template<class Pc>
//bool ConvexPolyhedron2D<Pc>::empty() const {
//    return size == 0;
//}

//template<class Pc>
//const typename ConvexPolyhedron2D<Pc>::Node &ConvexPolyhedron2D<Pc>::node( TI index ) const {
//    return nodes->global_at( index );
//}

//template<class Pc>
//typename ConvexPolyhedron2D<Pc>::Node &ConvexPolyhedron2D<Pc>::node( TI index ) {
//    return nodes->global_at( index );
//}

//template<class Pc>
//void ConvexPolyhedron2D<Pc>::for_each_boundary_measure( const std::function<void( const TF &boundary_measure, Dirac *dirac )> &f, TF /*weight*/ ) const {
//    if ( nb_nodes() == 0 ) {
//        if ( sphere_radius >= 0 )
...
//template<class Pc>
//void ConvexPolyhedron2D<Pc>::for_each_boundary_item( const std::function<void( const BoundaryItem &boundary_item )> &f, TF /*weight*/ ) const {
//    if ( nb_nodes() == 0 ) {
//        if ( sphere_radius >= 0 ) {
//            BoundaryItem item;
...
//template<class Pc>
//void ConvexPolyhedron2D<Pc>::resize( TI new_size ) {
//    if ( new_size > rese ) {
...
//void ConvexPolyhedron2D<Pc>::plane_cut_simd_tzcnt( TF cut_dx, TF cut_dy, TF cut_ps, CI cut_id, N<flags>, S<T> ) {
//    plane_cut_gen( cut_dx, cut_dy, cut_ps, cut_id, N<flags>() );
//}

//template<class Pc> template<int flags>
//void ConvexPolyhedron2D<Pc>::plane_cut_simd_tzcnt( TF cut_dx, TF cut_dy, TF cut_ps, CI cut_id, N<flags>, S<double> ) {
//    #ifdef __AVX512F__
...
//void ConvexPolyhedron2D<Pc>::plane_cut_gen( TF cut_dx, TF cut_dy, TF cut_ps, CI cut_id, N<flags>, BS &outside, DS &distances ) {
//    reset( outside );
...
//template<class Pc> template<int flags>
//void ConvexPolyhedron2D<Pc>::plane_cut_gen( TF cut_dx, TF cut_dy, TF cut_ps, CI cut_id, N<flags> ) {
//    if ( size <= 64 ) {
...
//template<class Pc> template<int flags>
//void ConvexPolyhedron2D<Pc>::plane_cut( std::array<const TF *,dim> cut_dir, const TF *cut_ps, const CI *cut_id, std::size_t nb_cuts, N<flags> ) {
//    // no simd ?
...
//template<class Pc>
//void ConvexPolyhedron2D<Pc>::plane_cut( std::array<const TF *,dim> cut_dir, const TF *cut_ps, const CI *cut_id, std::size_t nb_cuts ) {
//    return plane_cut( cut_dir, cut_ps, cut_id, nb_cuts, N<0>() );
//}

//template<class Pc>
//typename ConvexPolyhedron2D<Pc>::TF ConvexPolyhedron2D<Pc>::integral() const {
...
//void ConvexPolyhedron2D<Pc>::BoundaryItem::foreach_simplex( const TL &f ) const {

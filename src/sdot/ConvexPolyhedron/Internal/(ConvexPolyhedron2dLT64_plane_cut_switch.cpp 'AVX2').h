  ...
  void f( Nodes nodes, int &num_cut, int nb_cuts, int nodes_size, TF **cut_dir, CI *cut_ids, TF *cut_ps ) {
    ...
    for( ; ; ++num_cut ) {
      ...
      case_2: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
      ...
      case_3: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_3 = px_0[ 2 ];
      ...
      case_4: {
        ...
        SimdVec<TF,2> di_a( di_0[ 2 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_0[ 1 ] );
      ...
      case_5: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 2 ] = nx_s[ 0 ];
      ...
      case_9: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_11: {
        ...
        SimdVec<TF,2> di_a( di_0[ 3 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_12: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_4 = px_0[ 3 ];
      ...
      case_13: {
        ...
        SimdVec<TF,2> di_a( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 1 ] = nx_s[ 0 ];
      ...
      case_14: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_1 = px_0[ 3 ];
      ...
      case_17: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 0 ] = nx_s[ 0 ];
      ...
      case_18: {
        ...
        SimdVec<TF,2> di_a( di_0[ 1 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_21: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_26: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 0 ];
      ...
      case_27: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_5 = px_1[ 0 ];
      ...
      case_28: {
        ...
        SimdVec<TF,2> di_a( di_0[ 1 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 2 ] = nx_s[ 0 ];
      ...
      case_29: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_3 = px_1[ 0 ];
      ...
      case_30: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_1 = px_1[ 0 ];
      ...
      case_33: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 0 ] = nx_s[ 0 ];
      ...
      case_35: {
        ...
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_38: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_41: {
        ...
        nodes_size = 7;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_43: {
        ...
        SimdVec<TF,2> di_a( di_1[ 1 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_46: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_50: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_51: {
        ...
        nodes_size = 7;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_1[ 1 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_1[ 1 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_1[ 1 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_6 = px_1[ 1 ];
      ...
      case_52: {
        ...
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_1[ 1 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_1[ 1 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_1[ 1 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 3 ] = nx_s[ 0 ];
      ...
      case_53: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_1[ 1 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_1[ 1 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_1[ 1 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_4 = px_1[ 1 ];
      ...
      case_54: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 0 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_1[ 1 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 0 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_1[ 1 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 0 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_1[ 1 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_3 = px_1[ 1 ];
      ...
      case_55: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_1 = px_1[ 1 ];
      ...
      case_58: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 0 ] = nx_s[ 0 ];
      ...
      case_59: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 0 ];
      ...
      case_65: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_68: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_71: {
        ...
        nodes_size = 8;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_73: {
        ...
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_76: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_80: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 1 ];
      ...
      case_85: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_86: {
        ...
        nodes_size = 8;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_7 = px_1[ 2 ];
      ...
      case_87: {
        ...
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_1[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_1[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_1[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_1[ 0 ] = nx_s[ 0 ];
      ...
      case_88: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_1[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_1[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_1[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_5 = px_1[ 2 ];
      ...
      case_89: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_1[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_1[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_1[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_4 = px_1[ 2 ];
      ...
      case_90: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_3 = px_1[ 2 ];
      ...
      case_91: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_1 = px_1[ 2 ];
      ...
      case_94: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 2 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 2 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 2 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 0 ] = nx_s[ 0 ];
      ...
      case_95: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 1 ];
      ...
      case_103: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_107: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_110: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_113: {
        ...
        nodes_size = 9;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_115: {
        ...
        SimdVec<TF,2> di_a( di_1[ 3 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 3 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 3 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_118: {
        ...
        nodes_size = 7;
        SimdVec<TF,2> di_a( di_1[ 3 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 3 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 3 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_122: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_1[ 3 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 0 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 3 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 0 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 3 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 0 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_127: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 0 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_133: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_1[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_1[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_1[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_134: {
        ...
        nodes_size = 9;
        SimdVec<TF,2> di_a( di_1[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 2 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 2 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 2 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_8 = px_1[ 3 ];
      ...
      case_135: {
        ...
        SimdVec<TF,2> di_a( di_1[ 0 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 1 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 0 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 1 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 0 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 1 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_1[ 1 ] = nx_s[ 0 ];
      ...
      case_136: {
        ...
        nodes_size = 7;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_6 = px_1[ 3 ];
      ...
      case_137: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_5 = px_1[ 3 ];
      ...
      case_138: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_4 = px_1[ 3 ];
      ...
      case_139: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 0 ], di_1[ 2 ] );
        SimdVec<TF,2> di_b( di_0[ 1 ], di_1[ 3 ] );
        SimdVec<TF,2> px_a( px_0[ 0 ], px_1[ 2 ] );
        SimdVec<TF,2> px_b( px_0[ 1 ], px_1[ 3 ] );
        SimdVec<TF,2> py_a( py_0[ 0 ], py_1[ 2 ] );
        SimdVec<TF,2> py_b( py_0[ 1 ], py_1[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_3 = px_1[ 3 ];
      ...
      case_140: {
        ...
        nodes_size = 3;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_1[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_1[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_1[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_1 = px_1[ 3 ];
      ...
      case_143: {
        ...
        nodes_size = 7;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 1 ] );
        SimdVec<TF,2> di_b( di_1[ 3 ], di_0[ 2 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 1 ] );
        SimdVec<TF,2> px_b( px_1[ 3 ], px_0[ 2 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 1 ] );
        SimdVec<TF,2> py_b( py_1[ 3 ], py_0[ 2 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        px_0[ 0 ] = nx_s[ 0 ];
      ...
      case_144: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 2 ] );
        SimdVec<TF,2> di_b( di_1[ 3 ], di_0[ 3 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 2 ] );
        SimdVec<TF,2> px_b( px_1[ 3 ], px_0[ 3 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 2 ] );
        SimdVec<TF,2> py_b( py_1[ 3 ], py_0[ 3 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 2 ];
      ...
      case_145: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_1[ 2 ], di_0[ 3 ] );
        SimdVec<TF,2> di_b( di_1[ 3 ], di_1[ 0 ] );
        SimdVec<TF,2> px_a( px_1[ 2 ], px_0[ 3 ] );
        SimdVec<TF,2> px_b( px_1[ 3 ], px_1[ 0 ] );
        SimdVec<TF,2> py_a( py_1[ 2 ], py_0[ 3 ] );
        SimdVec<TF,2> py_b( py_1[ 3 ], py_1[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
        TF nx_0 = px_1[ 1 ];
      ...
      case_159: {
        ...
        nodes_size = 6;
        SimdVec<TF,2> di_a( di_0[ 3 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_1[ 0 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 3 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_1[ 0 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 3 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_1[ 0 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_163: {
        ...
        nodes_size = 5;
        SimdVec<TF,2> di_a( di_0[ 2 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 3 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 2 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 3 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 2 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 3 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );
      ...
      case_166: {
        ...
        nodes_size = 4;
        SimdVec<TF,2> di_a( di_0[ 1 ], di_1[ 3 ] );
        SimdVec<TF,2> di_b( di_0[ 2 ], di_0[ 0 ] );
        SimdVec<TF,2> px_a( px_0[ 1 ], px_1[ 3 ] );
        SimdVec<TF,2> px_b( px_0[ 2 ], px_0[ 0 ] );
        SimdVec<TF,2> py_a( py_0[ 1 ], py_1[ 3 ] );
        SimdVec<TF,2> py_b( py_0[ 2 ], py_0[ 0 ] );
        SimdVec<TF,2> dm_s = di_a / ( di_b - di_a );
        SimdVec<TF,2> nx_s = px_a - dm_s * ( px_b - px_a );
        SimdVec<TF,2> ny_s = py_a - dm_s * ( py_b - py_a );

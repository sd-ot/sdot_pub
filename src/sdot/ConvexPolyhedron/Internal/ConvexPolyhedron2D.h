...
//*/
//template<class Pc>
//class ConvexPolyhedron2D : public ConvexPolyhedron {
//public:
...
//    /**/                                 ConvexPolyhedron2D         ( const Box &box, CI cut_id = {} );
//    /**/                                 ConvexPolyhedron2D         ( ConvexPolyhedron2D &&that );
//    /**/                                 ConvexPolyhedron2D         ();
//    /**/                                ~ConvexPolyhedron2D         ();

//    ConvexPolyhedron2D&                   operator=                 ( const ConvexPolyhedron2D &that );
...
//#include "ConvexPolyhedron2D.tcc"
